...
<head>
  ...
  <title>Pingpong Labs - About Us</title>
  ...
  <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
      ...
      <nav class="navbar navbar-default navbar-white navbar-static-top" role="navigation">
        <div class="container">
          ...
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/">Pingpong Labs</a>
          </div>
    ...
    <!-- header -->
    <div class="container-fluid header" style="background-image: url(https://ununsplash.imgix.net/photo-1416339134316-0e91dc9ded92?q=75&fm=jpg&s=883a422e10fc4149893984019f63c818);">
      <div class="header-overlay"></div>
      <div class="header-body">
        <h2 class="awesome-title">ABOUT US</h2>
      </div>
    </div>
    <!-- end header -->
    ...
    <div class="container-fluid bg-white">
      <div class="container content">
        <div class="row">
          <div class="col-md-3">
            <div class="icon bg-orange"><i class="fa fa-5x fa-globe"></i></div>
          </div>
          <div class="col-md-9">
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            <div class="icon bg-midnight-blue"><i class="fa fa-5x fa-user-secret"></i></div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-3">
            <div class="icon bg-tourquise"><i class="fa fa-5x fa-lock"></i></div>
          </div>
          <div class="col-md-9">
            <h3>Lorem ipsum dolor</h3>
            <p>
        ...
        <div class="row">
          ...
          <div class="col-md-3">
          <div class="icon bg-alizarin"><i class="fa fa-5x fa-rocket"></i></div>
          </div>
        </div>
        <div class="section-space"></div>
      </div>
    ...
    <!-- footer -->
    <footer class="container-fluid bg-wet-asphalt">
      <div class="container">    
        <div class="row">
          <div class="col-md-3">
            ...
            <div class="col-md-3">
              ...
              <div class="col-md-3">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <p class="muted pull-right">© 2015 Pingpong Labs. All rights reserved</p>
                  </div>
                </div>
              </div>
            </footer>

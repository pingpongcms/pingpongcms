...
<head>
  ...
  <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
    ...
    <body>
      ...
      <div class="bg-sun-flower" id="about">
        <div class="container text-center">
          <h3 class="awesome-title">LITTLE OF US</h3>
          <p>
      ...
      <div class="container">
        <section id="features" class="section-content">
          <h3 class="awesome-title">OUR SERVICES</h3>
        <div class="section-space"></div>
          <!-- row -->
          <div class="row">
            <div class="col-md-3">
              <div class="icon bg-alizarin">
      ...
      <div class="findus bg-white">
        <h3 class="awesome-title">FIND US ON MAP</h3>  
      </div>

      @include('default::layouts.partials.map')
